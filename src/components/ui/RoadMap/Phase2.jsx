...
function Phase2() {
    const roadmap = [
        { x: 2, y: 40, title: "ادامه", desc: "تحلیل نیازها", color: "grat" },
        { x: 10, y: 44, title: "طراحی", desc: "UI/UX وایرفریم", color: "gray" },
        { x: 20, y: 65, title: "توسعه", desc: "کدنویسی", color: "gray" },
        { x: 30, y: 35, title: "تست", desc: "بررسی نهایی", color: "gray" },
